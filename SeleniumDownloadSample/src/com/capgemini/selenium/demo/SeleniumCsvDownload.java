...
public class SeleniumCsvDownload {
	...
	public static void main(String[] args) {
		System.setProperty("webdriver.chrome.driver",
				"D:\\Users\\smaringa\\Documents\\git files\\SeleniumPocs\\chromedriver_win32\\chromedriver.exe");

//		String downloadFilepath = "D:\\Users\\smaringa\\Documents\\git files\\SeleniumPocs\\SeleniumDownloadSample\\";

		HashMap<String, Object> chromePrefs = new HashMap<String, Object>();
		chromePrefs.put("profile.default_content_settings.popups", 0);
		chromePrefs.put("download.default_directory", "D:\\Users\\smaringa\\Documents\\git files\\SeleniumPocs\\SeleniumDownloadSample\\");
...
//		options.addArguments("--test-type");
		...
		System.out.println(chromeOptionsMap);
